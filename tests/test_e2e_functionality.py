...
class TestE2EScreenshotCapture(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.server = ComputerUseServer(computer_use=create_computer_use_for_testing())  # Test mode with mocks for cross-platform E2E
    ...
    def test_windows_screenshot_capture(self, mock_platform):
        ...
        test_server = ComputerUseServer(computer_use=create_computer_use_for_testing())
