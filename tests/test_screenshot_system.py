...
class TestScreenshotFactory(unittest.TestCase):
    ...
    def test_auto_detect_windows(self):
        ...
        with patch('platform.system', return_value='Windows'):
            with patch('mcp.platform_utils.get_recommended_screenshot_method', return_value='x11'):
    ...
    def test_fallback_chain(self):
        ...
        with patch('platform.system', return_value='Linux'):
            with patch('mcp.platform_utils.get_recommended_screenshot_method', return_value='x11'):
                ...
                with patch('mcp.screenshot.x11.X11Screenshot.is_available', 
                          return_value=False):
...
class TestScreenshotIntegration(unittest.TestCase):
    ...
    @patch('mcp.platform_utils.get_recommended_input_method', return_value='wsl2_powershell')
    @patch('mcp.platform_utils.get_recommended_screenshot_method', return_value='wsl2_powershell')
    ...
    def test_screenshot_uses_new_system(self):
        ...
        result = self.core.take_screenshot()
...
class TestPerformanceOptimization(unittest.TestCase):
    ...
    def test_lazy_import(self):
        ...
        self.assertNotIn('mcp.screenshot.windows', sys.modules)
        ...
        with patch('platform.system', return_value='Windows'):
            with patch('mcp.platform_utils.get_recommended_screenshot_method', return_value='x11'):
                ...
                self.assertIn('mcp.screenshot.x11', sys.modules)
