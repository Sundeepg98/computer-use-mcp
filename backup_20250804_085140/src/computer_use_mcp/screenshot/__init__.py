...
class ScreenshotFactory:
    ...
    def _create_fallback(config: Optional[Dict[str, Any]] = None) -> 'ScreenshotBase':
        ...
        implementations = [
            ('x11', lambda: __import__('computer_use_mcp.screenshot.x11', fromlist=['X11Screenshot']).X11Screenshot),
            ('windows', lambda: __import__('computer_use_mcp.screenshot.windows', fromlist=['WindowsScreenshot']).WindowsScreenshot),
        ]
