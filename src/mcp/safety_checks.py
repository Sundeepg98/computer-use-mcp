...
class SafetyChecker:
    ...
    def validate_command(self, command: str) -> Tuple[bool, Optional[str]]:
        ...
        try:
            ...
            if result:
                ...
                return (False, self.last_error or "Command validation failed")
        except Exception as e:
            return (False, str(e))
    ...
    def check_command_injection(self, command: str) -> bool:
        ...
        # This is already handled by check_command_safety, but add alias
        is_safe = self.check_command_safety(command)
        return not is_safe  # Return True if injection detected
    
    def check_privilege_escalation(self, command: str) -> bool:
