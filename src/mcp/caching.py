...
class CachedInputProvider:
    ...
    def __init__(self, provider: InputProvider, cache_mouse_position: bool = True):
        """
...
def cache_method(ttl: float = 1.0, key_func: Optional[Callable] = None):
    """
...
class SmartCache:
    ...
    def __init__(self, initial_ttl: float = 0.1, adapt_ttl: bool = True):
        """
...
def create_cached_computer_use(cache_screenshots: bool = True, screenshot_ttl: float = 0.1):
